  ...
  <body style="">
    ...
    <div class="container">
      ...
      <div class="jumbotron">
        ...
        <p><form action="createeventprocess.php" method="post">
				<div style="text-align: center;">Event Title <input name="title" type="text"><br>
				<br>
				Date (mm/dd/yyyy)<input name="date" type="text"><br>
				<br>
				Time (HH:SS am/pm)<input name="time" type="text"><br>
				<br>
				...
				<br><br>
				<input value="Propose Event" type="submit"></div>
			</form>
		</p>
      </div>
